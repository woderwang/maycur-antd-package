...
var RangePicker = function (_React$Component) {
    ...
    _createClass(RangePicker, [{
        ...
        value: function render() {
            ...
            var comClass = classNames(props.className, props.pickerClass, _defineProperty({}, props.prefixCls + '-disabled', props.disabled));
            return React.createElement(
                'span',
                { ref: this.savePicker, id: props.id, className: comClass, style: _extends({}, style, pickerStyle), tabIndex: props.disabled ? -1 : 0, onFocus: props.onFocus, onBlur: props.onBlur, onMouseEnter: props.onMouseEnter, onMouseLeave: props.onMouseLeave },
                React.createElement(
                    RcDatePicker,
