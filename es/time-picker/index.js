...
var TimePicker = function (_React$Component) {
    ...
    function TimePicker(props) {
        ...
        _this.renderTimePicker = function (locale) {
            ...
            var className = classNames(props.className, (_classNames = {}, _defineProperty(_classNames, props.prefixCls + '-' + props.size, !!props.size), _defineProperty(_classNames, props.prefixCls + '-disabled', props.disabled), _classNames));
