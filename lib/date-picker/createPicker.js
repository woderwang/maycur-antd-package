    ...
    var CalenderWrapper = function (_React$Component) {
        ...
        (0, _createClass3['default'])(CalenderWrapper, [{
            ...
            value: function render() {
                ...
                var spanClassName = (0, _classnames2['default'])(props.className, props.pickerClass, (0, _defineProperty3['default'])({}, prefixCls + '-disabled', props.disabled));
                return React.createElement(
                    'span',
                    { id: props.id, className: spanClassName, style: (0, _extends3['default'])({}, pickerStyle, props.style), onFocus: props.onFocus, onBlur: props.onBlur, onMouseEnter: props.onMouseEnter, onMouseLeave: props.onMouseLeave },
                    React.createElement(
                        _Picker2['default'],
