...
var RangePicker = function (_React$Component) {
    ...
    (0, _createClass3['default'])(RangePicker, [{
        ...
        value: function render() {
            ...
            var comClass = (0, _classnames2['default'])(props.className, props.pickerClass, (0, _defineProperty3['default'])({}, props.prefixCls + '-disabled', props.disabled));
            return React.createElement(
                'span',
                { ref: this.savePicker, id: props.id, className: comClass, style: (0, _extends3['default'])({}, style, pickerStyle), tabIndex: props.disabled ? -1 : 0, onFocus: props.onFocus, onBlur: props.onBlur, onMouseEnter: props.onMouseEnter, onMouseLeave: props.onMouseLeave },
                React.createElement(
                    _Picker2['default'],
