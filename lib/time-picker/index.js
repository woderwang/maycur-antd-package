...
var TimePicker = function (_React$Component) {
    ...
    function TimePicker(props) {
        ...
        _this.renderTimePicker = function (locale) {
            ...
            var className = (0, _classnames2['default'])(props.className, (_classNames = {}, (0, _defineProperty3['default'])(_classNames, props.prefixCls + '-' + props.size, !!props.size), (0, _defineProperty3['default'])(_classNames, props.prefixCls + '-disabled', props.disabled), _classNames));
