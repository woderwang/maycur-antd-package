...
var Table = function (_React$Component) {
    ...
    function Table(props) {
        ...
        _this.renderTable = function (contextLocale, loading) {
            ...
            return React.createElement(RcTable, (0, _extends5['default'])({ key: 'table' }, restProps, { onRow: _this.onRow, components: _this.components, prefixCls: prefixCls, data: data, columns: columns, showHeader: showHeader, className: classString, expandIconColumnIndex: expandIconColumnIndex, expandIconAsCell: expandIconAsCell, emptyText: !loading.spinning && locale.emptyText }));
        };
    ...
    (0, _createClass3['default'])(Table, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                'div',
                { className: (0, _classnames2['default'])(prefixCls + '-wrapper ' + prefixCls + '-flex', className), style: style },
                React.createElement(
                    _spin2['default'],
