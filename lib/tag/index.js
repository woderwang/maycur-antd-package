    ...
    (0, _createClass3['default'])(Tag, [{
        ...
        value: function render() {
            ...
            if (ghost) {
                ...
                tagStyle = (0, _extends3['default'])({ backgroundColor: 'transparent', color: type && type != 'mk' ? this.getTagStyleColor(type) : color ? color : 'rgba(0, 0, 0, 0.65)', border: type && type != 'mk' ? '1px solid ' + this.getTagStyleColor(type) : color ? '1px solid ' + color : '1px solid #d9d9d9' }, style);
            } else {
                tagStyle = (0, _extends3['default'])({ backgroundColor: color && !isPresetColor ? color : null }, style);
            }
